          ...
          <div class="container">
            <div class="row"> 
              <div class="col-12 col-md-12 col-lg-12">
                <div class="hero-logo mt-100 d-none d-sm-block wow fadeInUp" data-wow-duration="1s"><img src="<?php  echo get_theme_file_uri('/assets/images/logo/logo-light.png')?>" alt="logo hero"/></div>
              </div>
            </div>
            <div class="row row-content">
              <div class="col-12 col-md-5  wow fadeInUp" data-wow-duration="1s">
                <div class="hero-holder"><img class="img-fluid" src="<?php  echo get_theme_file_uri('/assets/images/mockup/book.png')?>" alt="screens"/></div>
              </div>
      ...
      <section class="feature feature-2 feature-left bg-white" id="feature3">
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-7 wow fadeInUp"><img class="img-fluid center-block" src="<?php  echo get_theme_file_uri('/assets/images/mockup/ipad.jpg')?>" alt="ipad"/></div>
          </div>
        </div>
      </section>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12 col-md-12 col-lg-6 pr-0 pl-0">
              <div class="col-img">
                <div class="bg-section"><img src="<?php  echo get_theme_file_uri('/assets/images/background/bg-1.jpg')?>" alt="Background"/></div>
              </div>
            </div>
            <div class="col-12 col-md-12 col-lg-6 col-content pl-100">
              <h3>About author</h3>
              <p>Torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis dapibus condimentum sit amet a augue. Sed non neque elit. Sed ut imperdiet nisi. Proin condimentum fermentum nunc, etiam pharetra, erat sed fermentum feugiat.</p><img src="<?php  echo get_theme_file_uri('/assets/images/mockup/signture.png')?>" alt="signture"/>
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="owl-carousel " data-slide="2" data-slide-res="1" data-autoplay="true" data-nav="false" data-dots="false" data-space="30" data-loop="true" data-speed="800">
                <div class="testimonial-panel wow fadeInUp" data-wow-duration="1s">
                  <div class="testimonial-body">
                    ...
                    <div class="testimonial--meta">
                      <div class="testimonial--author"><img src="<?php  echo get_theme_file_uri('/assets/images/testimonials/1.png')?>" alt="author"/>
                        <h5>Mark Smith</h5>
                        <p>Art director</p>
                      </div>
                    </div>
                ...
                <div class="testimonial-panel wow fadeInUp" data-wow-duration="1s">
                  <div class="testimonial-body">
                    ...
                    <div class="testimonial--meta">
                      <div class="testimonial--author"><img src="<?php  echo get_theme_file_uri('/assets/images/testimonials/2.png')?>" alt="author"/>
                        <h5>Jessy Arthur</h5>
                        <p>UX designer</p>
                      </div>
                    </div>
