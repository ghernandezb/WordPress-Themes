                    ...
                    <div class="container">
                        <div class="hotel_booking">
                            ...
                            <div class="special_offer_main">
                                <img src="<?php echo get_theme_file_uri('/img/special-offer-main.png')?>" alt="">
                            </div>
                            <!-- end offer start -->
                        </div>
                    </div>
                    ...
                    <div class="fullwidth_home_banner">
                        <ul>
                            ...
                            <li data-transition="random" data-slotamount="7" data-masterspeed="1000">
                                <img src="<?php echo get_theme_file_uri('/img/rev-slider/slider-one.jpg')?>" alt="slide" >
                        ...
                        <div class="row">
                                ...
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo get_theme_file_uri('/img/room-image-five.png')?>" alt=""></a>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo get_theme_file_uri('/img/room-image-nine.png')?>" alt=""></a>
                                        </div>
                                        <div class="room_title border-bottom-whitesmoke clearfix">
                                                <div class="left_room_title floatleft">
                                                    <h6>Double Room</h6>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo get_theme_file_uri('/img/room-image-thirteen.jpg')?>" alt=""></a>
                                        </div>
                                        <div class="room_title border-bottom-whitesmoke clearfix">
                                                <div class="left_room_title floatleft">
                                                    <h6>Single Room</h6>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="single_room_wrapper clearfix">
                                    <figure class="uk-overlay uk-overlay-hover">
                                        <div class="room_media">
                                            <a href="#"><img src="<?php echo get_theme_file_uri('/img/room-image-eight.png')?>" alt=""></a>
                                        </div>
                                        <div class="room_title border-bottom-whitesmoke clearfix">
                                                <div class="left_room_title floatleft">
                                                    <h6>Kids Room</h6>
                        ...
                        <div role="tabpanel">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#restaurant" aria-controls="restaurant" role="tab" data-toggle="tab"><img src="<?php echo get_theme_file_uri('/img/home-facilities-icon-eleven.png')?>" alt="restaurant"><span>restaurant</span></a>
                                </li>
                                <li role="presentation">
                                    <a href="#sports-club" aria-controls="sports-club" role="tab" data-toggle="tab"><img src="<?php echo get_theme_file_uri('/img/home-facilities-icon-seven.png')?>" alt="sports-club"><span>sports-club</span></a>
                                </li>
                                <li role="presentation">
                                    <a href="#pick-up" aria-controls="pick-up" role="tab" data-toggle="tab"><img src="<?php echo get_theme_file_uri('/img/home-facilities-icon-eight.png')?>" alt="pick-up"><span>pick-up</span></a>
                                </li>
                                <li role="presentation">
                                    <a href="#bar" aria-controls="bar" role="tab" data-toggle="tab"><img src="<?php echo get_theme_file_uri('/img/home-facilities-icon-nine.png')?>" alt="bar"><span>bar</span></a>
                                </li>
                                <li role="presentation">
                                    <a href="#gym" aria-controls="gym" role="tab" data-toggle="tab"><img src="<?php echo get_theme_file_uri('/img/home-facilities-icon-ten.png')?>" alt="gym"><span>gym</span></a>
                                </li>
                            </ul>                           
                                        ...
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5 col-sm-6">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="<?php echo get_theme_file_uri('/img/hotel-facility-one.jpg')?>" alt=""></a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="single-tab-content">
                                        <div class="row">
                                            <div class="co-lg-5 col-md-5">
                                                <div class="single-tab-image">
                                                    <a href="#"><img src="<?php echo get_theme_file_uri('/img/hotel-facility-three.jpg')?>" alt=""></a>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="single_content clearfix border-bottom-whitesmoke">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4 padding-left-0">
                                                <div class="post_media">
                                                    <a href="#"><img src="<?php echo get_theme_file_uri('/img/news-one.jpg')?>" alt=""></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="single_content clearfix margin-top-35 border-bottom-whitesmoke">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4 padding-left-0">
                                                <div class="post_media">
                                                    <a href="#"><img src="<?php echo get_theme_file_uri('/img/news-two.jpg')?>" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-8 padding-left-0">
                                                <div class="post_title clearfix">
                                        ...
                                        <div class="single_content clearfix margin-bottom-35 margin-top-35">
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-4 padding-left-0">
                                                <div class="post_media">
                                                    <a href="#"><img src="<?php echo get_theme_file_uri('/img/news-three.jpg')?>" alt=""></a>
                                                </div>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-8 padding-left-0">
                                                <div class="post_title clearfix">
                            ...
                            <div class="section_description">
                                <div class="clearfix demo" style="">
                                    <ul id="vertical" class="gallery list-unstyled">
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-18.jpg')?>">
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-18.jpg')?>" />
                                        </li>
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-21.jpg')?>"> 
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-21.jpg')?>" />
                                        </li>
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-22.jpg')?>"> 
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-22.jpg')?>" />
                                        </li>
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-23.jpg')?>"> 
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-23.jpg')?>" />
                                        </li>
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-24.jpg')?>"> 
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-24.jpg')?>" />
                                        </li>
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-25.jpg')?>"> 
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-25.jpg')?>" />
                                        </li>
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-26.jpg')?>"> 
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-26.jpg')?>" />
                                        </li>
                                        <li data-thumb="<?php echo get_theme_file_uri('/img/lightslider-img/cS-27.jpg')?>"> 
                                            <img alt="slider" src="<?php echo get_theme_file_uri('/img/lightslider-img/cS-27.jpg')?>" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                            ...
                                            <div class="single_says">
                                                ...
                                                <div class="customer_detail clearfix">
                                                    <div class="customer_pic alignleft-20">
                                                        <a href="#"><img src="<?php echo get_theme_file_uri('/img/customer-says-one.png')?>" alt=""></a>
                                                    </div>
