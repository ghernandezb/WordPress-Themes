                                                    ...
                                                    <aside class="widget woocommerce widget_product_categories">
                                                        ...
                                                        <ul class="product-categories">
                                                            ...
                                                            <li>
                                                                ...
                                                                <ul class='children'>
                                                                    <li>
                                                                        <a href="shop.html">Remington 1911 R1</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop.html">Revolvers</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="shop.html">Semi-Auto Handguns</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li class="cat-item">
                                                    ...
                                                    <ul class="products">
                                                        ...
                                                        <li class="product">
                                                            <div class="post_item_wrap">
                                                                ...
                                                                <div class="post_content">
                                                                    <h2 class="woocommerce-loop-product__title">Hi-Point Compact 9mm 3.5&#8243; Black Poly Grip/Frame Black</h2>
                                                        ...
                                                        <li class="product">
                                                            <div class="post_item_wrap">
                                                                ...
                                                                <div class="post_content">
                                                                    <h2 class="woocommerce-loop-product__title">Sig Sauer 1911-22-OD 1911 Olive Drab 10+1 22LR</h2>
                                                        ...
                                                        <li class="product">
                                                            <div class="post_item_wrap">
                                                                ...
                                                                <div class="post_content">
                                                                    <h2 class="woocommerce-loop-product__title">Glock PI4350201 G43 Double 9mm 3.4&#8243; FS Integral Grip Black</h2>
                                                                    <div class="star-rating" title="Rated 4.00 out of 5">
                                                                        <span class="width_80_per">
                                                                            <strong class="rating">4.00</strong> out of 5
                                                                        </span>
                                                        ...
                                                        <li class="product">
                                                            <div class="post_item_wrap">
                                                                ...
                                                                <div class="post_content">
                                                                    <h2 class="woocommerce-loop-product__title">Beretta JMN9S15CTC BU9 Nano 6+1 9mm 3.07&#8243;</h2>
                                                                    <div class="star-rating" title="Rated 4.00 out of 5">
                                                                        <span class="width_80_per">
                                                                            <strong class="rating">4.00</strong> out of 5
                                                                        </span>
                                        ...
                                        <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2 responsive_columns">
                                            <div class="column-1_2 sc_column_item sc_column_item_1 odd first"></div><div class="column-1_2 sc_column_item sc_column_item_2 even textalign_center">
                                                ...
                                                <div class="guns_ammo_info">
                                                    <p class="margin_bottom_null textalign_center">Lorem ipsum dolor sit amet, consectetur adipisicing elido eiusmod</p>
                                                    <p> tempor incididunt ut labore et dolore magna aliqua</p>

                                                </div>
                                                <a href="#" class="sc_button sc_button_square sc_button_style_border sc_button_size_large aligncenter">Learn More</a>
                                                    ...
                                                    <div class="column-1_2">
                                                            ...
                                                            <div class="post_featured">
                                                                <div class="post_thumb">
                                                                    <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                        <img alt="" src="http://placehold.it/370x209.jpg">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <article class="post_item post_accented_off">
                                                            <div class="post_featured">
                                                                <div class="post_thumb">
                                                                    <a class="hover_icon hover_icon_link" href="post-single.html">
                                                                        <img alt="Rental Firearms &#038; Fees" src="http://placehold.it/370x209.jpg">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="post_header">
                                                        ...
                                                        <div class="swiper-slide" data-style="width:100%;">
                                                            <div  class="sc_clients_item sc_clients_item_1 odd first">
                                                                <div class="sc_client_image">
                                                                    <img alt="" src="http://placehold.it/234x88.jpg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="swiper-slide" data-style="width:100%;">
