		...
		<div id="slider1" class="rev_slider"  data-version="5.0">
			<ul>
				...
				<li data-transition="zoomin"
					...
					<!-- MAIN IMAGE -->
					<img src="<?php echo get_theme_file_uri('/assets/images/sliders/slide-bg/1.jpg')?>" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
				...
				<li data-transition="slideoverdown"
					...
					data-masterspeed="2000">
					<!-- MAIN IMAGE -->
					<img src="<?php echo get_theme_file_uri('/assets/images/sliders/slide-bg/3.jpg')?>" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption" 
						data-x="center" data-hoffset="0" 
						data-y="center" data-voffset="-130" 
				...
				<li data-transition="zoomout"
					...
					data-masterspeed="2000">
					<!-- MAIN IMAGE -->
					<img src="<?php echo get_theme_file_uri('/assets/images/sliders/slide-bg/12.jpg')?>" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption" 
						data-x="center" data-hoffset="0" 
						data-y="center" data-voffset="-65" 
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="banner-img mt-20">
                    <img src="<?php echo get_theme_file_uri('/assets/images/banners/4.jpg')?>" alt="image">
                </div>
            </div>
            <!-- .col-md-3 end -->
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="banner-img">
                    <img src="<?php echo get_theme_file_uri('/assets/images/banners/5.jpg')?>" alt="image">
                </div>
                <!-- .col-md-3 end -->
            </div>
            <!-- .col-md-3 end -->
...
<section id="specials1" class="specials specials-1 menu-simple bg-overlay bg-parallax bg-overlay-dark">
    <div class="bg-section">
        <img src="<?php echo get_theme_file_uri('/assets/images/background/21.jpg')?>" alt="Background" />
    </div>
    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="dish-panel">
                                    <div class="dish--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/menu/dish/1.jpg')?>" alt="dish">
                                    </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="dish-panel">
                                    <div class="dish--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/menu/dish/2.jpg')?>" alt="dish">
                                    </div>
                                    <div class="dish--content">
                                        <div class="dish--content-bio">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="dish-panel">
                                    <div class="dish--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/menu/dish/3.jpg')?>" alt="dish">
                                    </div>
                                    <div class="dish--content">
                                        <div class="dish--content-bio">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="dish-panel">
                                    <div class="dish--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/menu/dish/4.jpg')?>" alt="dish">
                                    </div>
                                    <div class="dish--content">
                                        <div class="dish--content-bio">
                ...
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 ">
                        <div class="dish--img">
                            ...
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/1.jpg')?>" alt="dish img">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/specials/popup/1.jpg')?>" alt="dish popup">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="dish--img">
                            <div class="divider--shape-left"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/2.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/26.jpg')?>" alt="dish popup">
                            <div class="img-popup-overlay">
                ...
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            ...
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/3.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/27.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            <div class="divider--shape-right"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/4.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/28.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/19.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/20.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$34.95</div>
                                <h3 class="popup--title">Grilled Seafood Paella</h3>
                            </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/21.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$38.95</div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/22.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$18.95</div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 ">
                        <div class="dish--img">
                            <div class="divider--shape-left"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/13.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="dish--img">
                            <div class="divider--shape-left"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/14.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/2.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$34.95</div>
                                <h3 class="popup--title">Grilled Seafood Paella</h3>
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            <div class="divider--shape-right"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/15.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/3.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$38.95</div>
                                <h3 class="popup--title">Roast Sea Trout</h3>
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            <div class="divider--shape-right"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/16.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/4.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$18.95</div>
                                <h3 class="popup--title">Smoked Paprika</h3>
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 ">
                        <div class="dish--img">
                            <div class="divider--shape-left"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/19.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/29.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$12.95</div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="dish--img">
                            <div class="divider--shape-left"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/20.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/30.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            <div class="divider--shape-right"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/21.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/31.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            <div class="divider--shape-right"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/22.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/32.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$29.95</div>
                                <h3 class="popup--title">Roasted Steak Roulade</h3>
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 ">
                        <div class="dish--img">
                            <div class="divider--shape-left"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/9.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/5.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="dish--img">
                            <div class="divider--shape-left"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/10.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/6.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$33.95</div>
                                <h3 class="popup--title">Chicken Breast</h3>
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            <div class="divider--shape-right"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/11.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/7.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$29.95</div>
                                <h3 class="popup--title">Roasted Steak Roulade</h3>
                            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="row dish-panel">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class=" dish--img">
                            <div class="divider--shape-right"></div>
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-board/12.jpg')?>" alt="dish img">
                            <div class="dish--overlay">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row reservation">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="popup--img">
                            <img src="<?php echo get_theme_file_uri('/assets/images/menu/menu-grid/8.jpg')?>" alt="dish img">
                            <div class="img-popup-overlay">
                                <div class="popup--price">$29.95</div>
                                <h3 class="popup--title">Roasted Steak Roulade</h3>
                            </div>
...
<section id="testimonial1" class="testimonial testimonial-1 bg-overlay bg-parallax bg-overlay-dark pb-90">
    <div class="bg-section">
        <img src="<?php echo get_theme_file_uri('/assets/images/background/1.jpg')?>" alt="Background" />
    </div>
    <div class="container">
        <div class="divider--shape-1up"></div>
        <div class="row clearfix">
                            ...
                            <div class="testimonial-bordered">
                                ...
                                <div class="testimonial--meta">
                                    <div class="testimonial--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/testimonial/1.png')?>" alt="Testimonial Author">
                                    </div>
                    ...
                    <div class="testimonial-container">
                        ...
                        <div class="testimonial-panel">
                            <div class="testimonial-bordered">
                                ...
                                <div class="testimonial--meta">
                                    <div class="testimonial--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/testimonial/2.png')?>" alt="Testimonial Author">
                                    </div>
                                    <div class="testimonial--author">
                                        <h4>Henry Gabriel</h4>
                                    </div>
                    ...
                    <div class="testimonial-container">
                        ...
                        <div class="testimonial-panel">
                            <div class="testimonial-bordered">
                                ...
                                <div class="testimonial--meta">
                                    <div class="testimonial--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/testimonial/3.png')?>" alt="Testimonial Author">
                                    </div>
                                    <div class="testimonial--author">
                                        <h4>Leo Jaxon</h4>
                                    </div>
                    ...
                    <div class="testimonial-container">
                        ...
                        <div class="testimonial-panel">
                            <div class="testimonial-bordered">
                                ...
                                <div class="testimonial--meta">
                                    <div class="testimonial--img">
                                        <img src="<?php echo get_theme_file_uri('/assets/images/testimonial/4.png')?>" alt="Testimonial Author">
                                    </div>
                                    <div class="testimonial--author">
                ...
                <div class="carousel" data-slide="3" data-slide-rs="2" data-autoplay="true" data-nav="false" data-dots="false" data-space="0" data-loop="true" data-speed="800">
                    ...
                    <div class="blog-entry">
                        ...
                        <div class="entry--content">
                            ...
                            <div class="entry--img">
                                <a href="#">
								<img src="<?php echo get_theme_file_uri('/assets/images/blog/grid/1.jpg')?>" alt="entry image"/>
							</a>
                            </div>
                            <div class="entry--bio">
                    ...
                    <div class="blog-entry">
                        <div class="entry--content">
                            ...
                            <div class="entry--img">
                                <a href="#">
								<img src="<?php echo get_theme_file_uri('/assets/images/blog/grid/2.jpg')?>" alt="entry image"/>
							</a>
                            </div>
                            <div class="entry--bio">
                    ...
                    <div class="blog-entry">
                        <div class="entry--content">
                            ...
                            <div class="entry--img">
                                <a href="#">
								<img src="<?php echo get_theme_file_uri('/assets/images/blog/grid/3.jpg')?>" alt="entry image"/>
							</a>
                            </div>
                            <div class="entry--bio">
                    ...
                    <div class="blog-entry">
                        ...
                        <div class="entry--content">
                            ...
                            <div class="entry--img">
                                <a href="#">
							<img src="<?php echo get_theme_file_uri('/assets/images/blog/grid/4.jpg')?>" alt="entry image"/>
						</a>
                            </div>
                            <div class="entry--bio">
                    ...
                    <div class="blog-entry">
                        ...
                        <div class="entry--content">
                            ...
                            <div class="entry--img">
                                <a href="#">
							<img src="<?php echo get_theme_file_uri('/assets/images/blog/grid/5.jpg')?>" alt="entry image"/>
						</a>
                            </div>
                            <div class="entry--bio">
