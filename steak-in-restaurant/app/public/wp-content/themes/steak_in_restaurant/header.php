...
<head>
    ...
    <!--[if lt IE 9]>
      <script src="/wp-content/themes/steak_in_restaurant/assets/js/html5shiv.js"></script>
      <script src="/wp-content/themes/steak_in_restaurant/assets/js/respond.min.js"></script>
    <![endif]-->
</head>
<body>
	<div class="preloader">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="logo" href="index.html">
					<img class="logo-light" src="<?php echo get_theme_file_uri('/assets/images/logo/logo-light.png')?>" alt="Steakin Logo" draggable="false">
					<img class="logo-dark" src="<?php echo get_theme_file_uri('/assets/images/logo/logo-dark.png')?>" alt="Steakin Logo" draggable="false">
				</a>
            </div>
    ...
    <div class="module-content module-box cart-box">
        <div class="cart-overview">
            <ul class="list-unstyled">
                <li>
                    <img class="img-responsive" src="<?php echo get_theme_file_uri('/assets/images/shop/thumb/6.jpg')?>" alt="product" />
                ...
                <li>
                    <img class="img-responsive" src="<?php echo get_theme_file_uri('/assets/images/shop/thumb/7.jpg')?>" alt="product" />
                    <div class="product-meta">
...
============================================= -->
    <div class="widget widget-recent-posts">
        ...
        <div class="widget--content">
            <div class="entry">
                <img src="<?php echo get_theme_file_uri('/assets/images/blog/thumb/1.jpg')?>" alt="title" />
            ...
            <div class="entry">
                <img src="<?php echo get_theme_file_uri('/assets/images/blog/thumb/2.jpg')?>" alt="title" />
                <div class="entry-desc">
                    <div class="entry-meta">
